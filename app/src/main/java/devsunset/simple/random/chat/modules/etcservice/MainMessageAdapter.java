...
/**
 * <PRE>
 * SimpleRandomChat MainMessageAdapter
 * </PRE>
 *
 * @author devsunset
 * @version 1.0
...
public class MainMessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public MainMessageAdapter(ArrayList<MessageItem> MessageItemArrayList){
...
//        if(MessageItemArrayList.get(position).drawableId == R.drawable.new_message){
//            myViewHolder.list_item_rows.setBackgroundColor(R.drawable.newmessage_bg);
//        } else if(MessageItemArrayList.get(position).drawableId == R.drawable.man){
//            myViewHolder.list_item_rows.setBackgroundColor(R.drawable.man_bg);
//        } else if(MessageItemArrayList.get(position).drawableId == R.drawable.woman){
//            myViewHolder.list_item_rows.setBackgroundColor(R.drawable.woman_bg);
//        } else if(MessageItemArrayList.get(position).drawableId == R.drawable.trash){
//            myViewHolder.list_item_rows.setBackgroundColor(R.drawable.light_gray);
//        }
    }
